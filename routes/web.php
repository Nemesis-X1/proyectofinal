...
Route::group(['middleware' => 'auth', 'prefix' => 'admin'], function () {
    ...
    Route::resource('inventario', InventarioControlller::class)->except('show', 'destroy');
    Route::get('inventario-reporte', [InventarioControlller::class, 'reporte'])->name('inventario.reporte');
    Route::get('inventario-reporte-pdf', [InventarioControlller::class, 'exportarReportePDF'])->name('inventario.reporte.pdf');
